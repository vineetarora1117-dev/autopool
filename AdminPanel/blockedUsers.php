...
$stmt = $pdo->prepare("SELECT u.*, f.my_package, f.direct_team_count FROM users u LEFT JOIN user_financial_summary f ON u.user_id = f.user_id WHERE u.status = 'Blocked' ORDER BY u.created_at DESC LIMIT ? OFFSET ?");
