...
$stmt = $pdo->prepare("SELECT u.*, f.my_package, f.direct_team_count FROM users u LEFT JOIN user_financial_summary f ON u.user_id = f.user_id WHERE u.status = 'Inactive' ORDER BY u.created_at DESC LIMIT ? OFFSET ?");
...
<div class="breadcrumb">
    <a href="index.php">Dashboard</a> / Inactive Members
</div>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $color = $status_lower === 'active' ? '#2ecc71' : ($status_lower === 'blocked' ? '#ff4d4d' : 'orange');
