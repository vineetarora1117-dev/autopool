...
if (!array_key_exists($pack, $wallet_map)) {
    die("Invalid package wallet selected.");
}
...
// Fetch the internal transfer fee percentage for this package wallet from wallet_configurations
...
// Fetch recent 10 transactions related to this package wallet
$stmtTx = $pdo->prepare("
