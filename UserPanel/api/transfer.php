...
try {
    ...
    // 1b. Check referral qualification: no of directs >= Level No * 2
    $levelMap = [
    ...
    if ($directsCount < $requiredDirects) {
        echo json_encode([
            'success' => false,
            'message' => "Transfer Blocked: This operation requires at least $requiredDirects direct referrals. You currently have $directsCount directs."
        ]);
        $pdo->rollBack();
        exit;
    }
