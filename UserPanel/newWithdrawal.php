...
$stmtFees = $pdo->query("SELECT wallet_type, external_withdrawal_fee_percent FROM wallet_configurations");
            ...
            <form id="withdrawalForm">
                <div class="form-group" style="margin-bottom:15px;">
                    ...
                    <select name="source_wallet" id="source_wallet" class="form-control" style="width:100%; background:rgba(0,0,0,0.5); border:1px solid rgba(255,183,3,0.3); color:#fff; padding:10px; border-radius:6px; outline:none;" required>
                        ...
                        <option value="booster_wallet" data-fee="<?php echo $feesList['booster_wallet'] ?? 10; ?>">Booster Wallet ($<?php echo number_format($summary['booster_wallet'] ?? 0, 2); ?>)</option>
                    </select>
                </div>
                <div class="form-group" style="margin-bottom:15px;">
