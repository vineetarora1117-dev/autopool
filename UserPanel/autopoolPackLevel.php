...
// Query level transactions for this user and package wallet
$stmt = $pdo->prepare("
    SELECT * FROM transactions 
    WHERE user_id = ? AND transaction_type = 'level_income' AND wallet_type = ? 
    ORDER BY id DESC
");
...
<div id="autopoolPack<?php echo $pack; ?>Level" class="content-section active-view">
    <div class="profile-header-bar">
        <div class="profile-header-title">Infinity Crypto Hub <?php echo $pack; ?> - Level Income</div>
            ...
            <tbody>
                <?php if (empty($incomes)): ?>
                    <tr style="height: 50px; border-bottom: 1px solid rgba(255,255,255,0.05); color:#a0aec0;">
                        <td colspan="6" style="text-align: center;">No level team income payouts recorded for this pack yet.</td>
                    </tr>
                <?php else: ?>
                    <?php 
                    $idx = 1;
