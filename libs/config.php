...
$PACKAGE_CONFIG = [
    ...
    'main_30' => [
        ...
        'autopool_levels' => 8,
        'autopool_amount' => 1.625,
        'sponsor_amount' => 10.00,
        'level_levels' => 4,
        'level_amount' => 0.50,
        'company_revenue' => 5.00,
        'reward_reserve' => 0.00,
    ...
    'main_60' => [
        ...
        'autopool_levels' => 8,
        'autopool_amount' => 3.25,
        'sponsor_amount' => 20.00,
        'level_levels' => 4,
        'level_amount' => 1.00,
        'company_revenue' => 10.00,
        'reward_reserve' => 0.00,
    ...
    'main_120' => [
        ...
        'autopool_levels' => 8,
        'autopool_amount' => 6.50,
        'sponsor_amount' => 40.00,
        'level_levels' => 4,
        'level_amount' => 2.00,
        'company_revenue' => 20.00,
        'reward_reserve' => 0.00,
    ...
    'main_240' => [
        ...
        'autopool_levels' => 8,
        'autopool_amount' => 13.00,
        'sponsor_amount' => 80.00,
        'level_levels' => 4,
        'level_amount' => 4.00,
        'company_revenue' => 40.00,
        'reward_reserve' => 0.00,
    ...
    'main_480' => [
        ...
        'autopool_levels' => 8,
        'autopool_amount' => 26.00,
        'sponsor_amount' => 160.00,
        'level_levels' => 4,
        'level_amount' => 8.00,
        'company_revenue' => 80.00,
        'reward_reserve' => 0.00,
